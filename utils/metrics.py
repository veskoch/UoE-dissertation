...
class ROUGE(ExternalEvaluator):
  ...
  def score(self, labels_file, predictions_path):
    ...
    # Google's seq2seq
    # r = rouge.rouge(predictions, labels)
...
class MusicScores(ExternalEvaluator):
    ...
    def _collect_datapoints(self, i, datapoints,
      ...
      if prediction_stream:
        ...
        print("INFO: Failed to convert MIDI predicted at index {} to Music21 stream.".format(i)) 
      ...
      try:
        ...
        print("INFO: Failed to infer beat from track at index {}.".format(i)) 
